...
export default async function ExplorePage() {
  ...
  return (
    <>
      ...
      />
      <section className="relative pt-20 pb-8 md:pt-24 md:pb-12 overflow-hidden bg-gradient-to-b from-green-50/50 to-white">
      ...
      <section className="pt-4 md:pt-7 pb-4 md:pb-8 bg-white relative z-20">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 md:mb-12 max-w-6xl mx-auto">
      ...
      <section className="pt-8 md:pt-12 pb-10 md:pb-24 bg-gray-50">
        <div className="container mx-auto px-4">
